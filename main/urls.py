...
router.register(r"bootcamp-tipi", BootcampTipiViewSet)
router.register(r"telimler", TəlimlərViewSet)
router.register(r"email-subscription", EmailSubscriptionViewSet)
router.register(r"sessiya-qeydiyyati", SessiyaQeydiyyatiViewSet)
